...
const Navigation = () => {
    ...
    return (
        <>
                ...
                <div className="max-w-screen-2xl h-full flex flex-wrap items-center justify-between mx-auto my-auto">
                    ...
                    <div className="hidden gap-6 lg:flex">
                        <div className="flex gap-4">
                            ...
                            <Link className="pointer-events-none flex place-items-center gap-2 p-8 lg:pointer-events-auto lg:p-0" href="https://wa.me/989125616174" target="_blank" rel="noopener noreferrer">
            ...
            <MobileNavbar openDrawer={openMobileNavbarDrawer} onClose={() => setOpenMobileNavbarDrawer(false)} />
        </>
    );
}
