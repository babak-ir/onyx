...
const Footer = () => {
    return (
        <div className="w-full p-6 md:px-24 md:py-32" style={{ backgroundImage: "linear-gradient(0deg, rgba(72, 32, 25, 0.1) 0%, rgba(72, 32, 25, 0.09) 24.9%, rgba(72, 32, 25, 0.08) 47.06%, rgba(72, 32, 25, 0.07) 69.21%, rgba(255, 255, 255, 0.1) 100%)" }}>
